...
switch ( $wp_list_table->current_action() ) {
	...
	default:
		...
		$location = apply_filters( "handle_bulk_actions-{$screen}", $location, $wp_list_table->current_action(), $tags ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.Usebaizonn-learning-center
		break;
}
 ...
 */
do_action( "after-{$taxonomy}-table", $taxonomy );  // phpcs:ignore WordPress.NamingConventions.ValidHookName.Usebaizonn-learning-center
